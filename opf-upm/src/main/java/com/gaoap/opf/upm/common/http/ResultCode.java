...
public enum ResultCode implements IErrorCode {
    ...
    PARAMETER_ERROR(400, "提交参数不符合规范"),
    PASSWORD_ERROR(403, "密码错误"),
    USER_NOT_FOUND(403, "查询不到用户，或用户信息有误");
    private int code;
 ...
 * 　　服务器已成功处理了请求，但返回的实体头部元信息不是在原始服务器上有效的确定集合，而是来自本地或者第三方的拷贝。当前的信息可能是原始版本的子集或者超集。例如，包含资源的元数据可能导致原始服务器知道元信息的超集。使用此状态码不是必须的，而　　　　且只有在响应不使用此状态码便会返回200 OK的情况下才是合适的。
 * 204 No Content
